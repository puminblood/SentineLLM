...
pub fn bson_binary_from_slice(slice: &Vec<u8>) -> Bson {
    /*
...
pub fn bson_to_vec(bson: Bson) -> Option<Vec<u8>> {
/*
...
pub fn encrypt(name: &str, data: &[u8], nonce:&Vec<u8> , cipher : &Aes256Gcm) -> Result<EncryptedHar, aes_gcm::aead::Error> {
/*
...
pub fn decrypt_data(document: EncryptedHar, cipher: &Aes256Gcm) -> Result<Vec<u8>, aes_gcm::aead::Error> {
/*
